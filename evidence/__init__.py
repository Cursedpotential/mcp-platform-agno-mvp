...
_LAZY = {
    "ArtifactRef": ("evidence.custody", "ArtifactRef"),
    "ingest_artifact": ("evidence.custody", "ingest_artifact"),
    "DisclosureTier": ("evidence.normalize", "DisclosureTier"),
    "NormalizedRecord": ("evidence.normalize", "NormalizedRecord"),
    "ToolRegistry": ("evidence.registry", "ToolRegistry"),
    "registry": ("evidence.registry", "registry"),
}
