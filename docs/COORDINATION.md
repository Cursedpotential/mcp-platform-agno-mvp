...
| R9 Matter MVP | Matter/CourtCase, source resolution, unsafe evidence promotion | Built/tested and pushed to `main`; custody inspection `be286a8`; migration unapplied, undeployed |
