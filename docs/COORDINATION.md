...
| R9 Matter MVP | Matter/CourtCase, source resolution, unsafe evidence promotion | Built/tested and pushed to `main`; migration unapplied, undeployed; custody-inspection follow-on local |
