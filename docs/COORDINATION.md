...
| R9 Matter MVP | Matter/CourtCase, source resolution, unsafe promotion, custody inspection, read-only court readiness | Base slice pushed; readiness working slice locally verified; migration unapplied, undeployed |
