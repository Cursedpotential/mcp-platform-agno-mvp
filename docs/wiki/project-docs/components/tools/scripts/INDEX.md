...
High-value utility scripts for evidence processing, document conversion, and data quality assurance. Use this as a reference library; use the architecture tool catalog for the current live MCP inventory.
...
5. Update this index
6. Update [architecture tool catalog](../../architecture/TOOL_CATALOG.md) if active tool exposure or status changes
