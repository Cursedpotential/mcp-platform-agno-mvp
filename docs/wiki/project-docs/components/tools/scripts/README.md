...
This section documents utility scripts that can support evidence handling, export cleanup, conversion, and validation. It is useful working reference material, but it is not the canonical inventory of live MCP-exposed tools.
...
6. Update [architecture tool catalog](../../architecture/TOOL_CATALOG.md) if it affects active tool exposure or status
...
- **Tool Catalog**: [Architecture Tool Catalog](../../architecture/TOOL_CATALOG.md)
