...
**ALL agents must have Ask User Question tool enabled and use it proactively.**

### When to Ask Questions (ALL Agents)
- Before making assumptions about what user wants
- When scope is unclear
- When multiple approaches are possible
- When legal interpretation is needed
- Before generating final output
- When user input would improve quality
...
### LGL-opposing-counsel Questions
- "What's the strongest argument you're making?"
- "What evidence supports your position?"
- "What procedural requirements apply?"
- "What's your biggest concern about this case?"

### LGL-judge Questions
- "What court is this for? (circuit, appeals)"
- "What procedural stage? (motion, trial, appeal)"
- "Are there any prior rulings I should know about?"
- "What's the core legal issue you want reviewed?"
