...
> _Byline: Claude Code · Kimi K3 (drift-fix) · 2026-08-12 — ADR-0049/0051 index rows updated for D-048..D-052; ADR-0052 placeholder row added; ADR-0015/0026/0027 rows annotated SUPERSEDED-by-0042/0040._
...
| (0052) | PG change-detection/CDC spine + Stage-2 extraction (trigger/outbox/cursor design; the always-on worker wrapping `ingest.context-drain`) | **QUEUED — not yet drafted** (forward-referenced by ADR-0051 invariant 4 and DECISION_LOG D-048..D-052) |
