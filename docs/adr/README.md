...
> 2026-08-18 (ADR-0059 index and supersession links); Codex · GPT-5 · 2026-08-29
> (ADR-0048/0049 partial-supersession boundary reconciled with accepted ADR-0061)._
...
| 0048 | Historical Go worker/SBV universal-ingestor decision; streaming decoder assets and messaging-first history survive | **Accepted historical record; superseded in part by ADR-0061 (2026-08-29).** Workbench is the shell/auth/context boundary; SBV is a storage-free preview client. Common Go selection survives, but SBV-owned storage/auth/hashing/orchestration and permanent Python orchestration do not. |
| 0049 | Historical SBV universal-parser/app direction; common Go-selected parser contract survives | **Accepted with 2026-08-12 amendment; superseded in part by ADR-0061 (2026-08-29).** Go-native and governed `platform-tools` adapters share one selection contract; SBV no longer owns the all-in-one app, canonical storage, auth, or custody. UIW context fingerprints are non-custody; evidence H1/H2/H3 begins at promotion and dispatches by exact canon tuple. |
