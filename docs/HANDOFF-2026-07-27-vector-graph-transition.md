...
| **ADRs** | 0040 ACCEPTED (Weaviate), 0041 accepted-in-direction (MemGQL Zero variant A GO — MemGQL Community is free incl. all 8 connectors + MCP server), 0037 blocker CLOSED (CF federates streamable HTTP; graphiti already behind it). All committed on `docs/adr-graphiti-memory`. |
