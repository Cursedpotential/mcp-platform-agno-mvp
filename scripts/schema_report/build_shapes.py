...
A_tables=["working.normalized_record","working.message","working.message_participant","working.conversation","working.attachment","working.call_log","reference.entity","reference.person","working.organization","working.phone","working.handle","working.email","working.account","reference.entity_alias","reference.id_xref","analysis.evidence_item","analysis.factor_citation","reference.custody_factor","analysis.finding","analysis.evidence_task","analysis.legal_timeline_event","analysis.vw_court_export"]
