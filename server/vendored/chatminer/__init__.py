...
Usage:
    ...
    # Programmatic
    from server.vendored.chatminer import parse_file, segment_messages, extract_artifacts
...
from server.vendored.chatminer.core.pipeline import parse_file, parse_multiple, parse_directory
