...
from server.vendored.chatminer.core.types import ParseResult
from server.vendored.chatminer.parsers import get_parser_for_file, PARSER_REGISTRY
from server.vendored.chatminer.segmenters import get_segmenter
...
def cmd_discover(args: argparse.Namespace) -> int:
    ...
    from server.vendored.chatminer.parsers.discovery import discover_transcripts, print_discovery_report
