"""Atomic tool: Perplexity plugin copy-paste markdown -> NormalizedRecords (chatminer-backed).
...
@register(
    ...
    description="Perplexity plugin copy-paste markdown -> normalized message records",
    accept=lambda hint, size: hint.endswith((".md", ".txt")),
    provenance="vendored: chatminer/parsers/perplexity_plugin.py",
)
def parse(payload: dict[str, Any]) -> dict[str, Any]:
    return run_chatminer_parser(PerplexityPluginParser, payload)
