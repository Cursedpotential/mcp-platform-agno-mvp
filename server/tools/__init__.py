"""server.tools — atomic tool modules, ONE PER PARSER/FORMAT (owner intent:
...
reference.load_builtin_tools(); importing self-registers the module's tools.
...
Shared helpers (timestamps, output shaping) live in server.tools._common.
"""
