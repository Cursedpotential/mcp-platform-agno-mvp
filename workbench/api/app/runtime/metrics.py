...
"""GET /metrics — trivial in-process Prometheus-style counters + request timing.

Kept from the donor kit essentially unchanged (self-contained, no boto3/lancedb,
no chunking/embedding concepts) — deemed "trivial" per the build spec.
"""
