...
Temporal. It starts `engine/uiw.UniversalImportWorkflow`, sends preview
...
- Dockerfile: `/docker/universal-import-starter/Dockerfile`
...
- Watch paths: `engine/**`, `docker/universal-import-starter/**`, and
  `deploy/universal-import-starter.yaml`

Required secrets and environment are declared in
`deploy/universal-import-starter.yaml`. No secret value belongs in this image,
