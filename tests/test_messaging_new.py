...
from server.evidence.tools.messaging_transcript import parse as transcript_parse
from server.evidence.tools.messaging_csv import parse as csv_parse, looks_like_messages_csv
...
def test_imessage_pdf_import_available():
    ...
    from server.evidence.tools import imessage_pdf  # noqa: F401
...
def test_imessage_pdf_rejects_without_pdf_lib(tmp_path, monkeypatch):
    ...
    from server.evidence.tools.imessage_pdf import parse
